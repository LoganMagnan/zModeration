...
public class BlacklistCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (!(sender instanceof Player)) {
            if (args.length == 0) {
                this.main.getServer().getConsoleSender().sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("blacklist-usage")));
        ...
        if (!player.hasPermission(this.main.getMessagesConfig().getConfig().getString("blacklist-permission-node"))) {
        ...
        if (args.length == 0) {
            player.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("blacklist-usage")));
