...
public class SetSuffixCommand extends BaseCommand {
    ...
    public void executeAs(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        String suffix = Utils.getMessage(args, 2);

        rank.setSuffix(Utils.translate(suffix));
        rank.save();

        sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-suffix-updated")));
    }
