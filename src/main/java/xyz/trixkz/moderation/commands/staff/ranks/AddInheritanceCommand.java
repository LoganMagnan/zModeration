...
public class AddInheritanceCommand extends BaseCommand {
    ...
    public void executeAs(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (rank.getInheritedRanks().contains(inheritedRank)) {
            sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-already-has-inheritance")));

            return;
        }

        rank.getInheritedRanks().add(inheritedRank);
        rank.save();

        sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-added-inheritance")));
    }
