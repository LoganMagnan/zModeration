...
public class AddPermissionCommand extends BaseCommand {
    ...
    public void executeAs(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (rank.hasPermission(permission)) {
            sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-already-has-permission")));
        ...
        sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-added-permission")));
    }
