...
public class SetPrefixCommand extends BaseCommand {
    ...
    public void executeAs(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        String prefix = Utils.getMessage(args, 2);

        rank.setPrefix(Utils.translate(prefix));
        rank.save();

        sender.sendMessage(Utils.translate(this.main.getMessagesConfig().getConfig().getString("rank-prefix-updated")));
    }
