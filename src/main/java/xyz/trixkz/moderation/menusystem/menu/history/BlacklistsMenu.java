...
public class BlacklistsMenu extends PaginatedMenu {
    ...
    public BlacklistsMenu(PlayerMenuUtil playerMenuUtil, OfflinePlayer offlinePlayer) {
    ...
    public String getMenuName() {
        return Utils.translate("&eLook at " + this.offlinePlayer.getName() + "'s blacklists...");
    }
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        if (event.getView().getTitle().equalsIgnoreCase(Utils.translate("&eLook at " + this.offlinePlayer.getName() + "'s blacklists..."))) {
    ...
    public void setMenuItems(Player player) {
        ...
        for (int i = 0; i < this.getMaxItemsPerPage(); i++) {
            ...
            if (this.punishments.get(i) != null) {
                ...
                ItemStackButton blacklist = new ItemStackButton(
                ...
                this.inventory.addItem(blacklist.makeItemStack());
            }
        }
    }
}
