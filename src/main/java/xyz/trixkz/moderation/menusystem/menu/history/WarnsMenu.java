...
public class WarnsMenu extends PaginatedMenu {
    ...
    public WarnsMenu(PlayerMenuUtil playerMenuUtil, OfflinePlayer offlinePlayer) {
    ...
    public String getMenuName() {
        return Utils.translate("&eLook at " + this.offlinePlayer.getName() + "'s warns...");
    }
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        if (event.getView().getTitle().equalsIgnoreCase(Utils.translate("&eLook at " + this.offlinePlayer.getName() + "'s warns..."))) {
    ...
    public void setMenuItems(Player player) {
        ...
        for (int i = 0; i < this.getMaxItemsPerPage(); i++) {
            ...
            if (this.punishments.get(i) != null) {
                ...
                ItemStackButton warn = new ItemStackButton(
                        ...
                        new String[]{
                                ...
                                "&fDuration: &d" + (punishment.getRemainingDurationAsALong() == 0L ? "Expired" : Utils.makeTimeReadable(punishment.getRemainingDurationAsALong())),
...
//                            (punishment.isUnbanned() ? "&fUnbanned reason: &d" + punishment.getUnbannedReason() : "")
                ...
                this.inventory.addItem(warn.makeItemStack());
            }
        }
    }
}
